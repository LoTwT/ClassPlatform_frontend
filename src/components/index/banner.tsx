...
import { BannerData, getAllBanner } from "../../models/banner"

export default function Banner() {
  const [banners, setBanners] = useState<BannerData[] | undefined>(
    appData?.banners,
  )
  ...
  return (
    <div
      className="banner"
      style={{ backgroundColor: banners ? banners[cur].color : "#000" }}
    >
      <div className="page">
